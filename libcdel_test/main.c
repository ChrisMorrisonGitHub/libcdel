...
int main(int argc, char** argv)
{
    ...
    while ((line = read_string(fp)) != NULL)
    {
        ...
        if (sscanf(line, "%s\t%s\t%s\t%s\t%s\t%s\t%s\t%s", base2, base2spc, base85, base16upc, base32, base58, base64, base91) != 8)
        {
        ...
        fprintf(stdout, "Test of base16 verification function, string %02d  (uppercase)...  ", cline);
        ...
        /*fprintf(stdout, "Test of base2 verification function, string %02d (lowercase)...    ", cline);
