...
${OBJECTDIR}/_ext/1445274692/base16.o: ../../src/base16.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/base16.o ../../src/base16.c

${OBJECTDIR}/_ext/1445274692/base2.o: ../../src/base2.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/base2.o ../../src/base2.c

${OBJECTDIR}/_ext/1445274692/base32.o: ../../src/base32.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/base32.o ../../src/base32.c

${OBJECTDIR}/_ext/1445274692/base58.o: ../../src/base58.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/base58.o ../../src/base58.c

${OBJECTDIR}/_ext/1445274692/base64.o: ../../src/base64.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/base64.o ../../src/base64.c
